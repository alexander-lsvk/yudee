...
Deno.serve(async (req) => {
  try {
    ...
    // Set up subscription data with trial if applicable
    const subscriptionData = !profile.premium_trial_used ? {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      success_url,
      cancel_url,
      subscription_data: mode === 'subscription' ? subscriptionData : undefined
    });
